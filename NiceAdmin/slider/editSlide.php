...
if (isset($_GET['update'])) {
    $id = $_GET['update'];
    $select = "SELECT * From `main-slider` where id = $id";
    ...
    if (isset($_POST['edit'])) {
        ...
        if ($image_type_new != 'jpg' && $image_type_new != 'png' && $image_type_new != 'jpeg') {
            ...
            $update = "UPDATE `main-slider` SET `id`=$id,`image`='$file_name' WHERE id = $id";
            $u = mysqli_query($conn, $update);
            $insert_msg[] = 'تم تعديل الصورة بنجاح';
        }
    }
}
?>
...
<div class="main" id="main" style="direction: rtl;">
    <div class="container col-md-6 text-cneter">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-center"><strong>تعديل صورة في السلايد</strong></h5>
                ...
                <form class="row g-3 needs-validation" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <label for="validationCustom01" class="form-label"><strong>الصورة الحالية :</strong></label>
                        <img src="upload/<?= $row['image'] ?>" width="50px" alt="">
                        <input type="file" class="form-control" name="file" id="validationCustom01" value="<?= $row['image'] ?>">

...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@400;500;600;700&family=Jost:wght@400;600;800&family=Lemonada:wght@400;500;700&display=swap"
        rel="stylesheet">
...
<body class="direction_right">


    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">فاشونيستا</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="men.html">رجالي</a>
                        </li>
    ...
    <main id="main" class="">
        ...
        <section id="features " class="features">
            ...
            <div class="container section-title text-center mt-3" data-aos="fade-up">
                <h3 class="features-text"> الصالونات </h3>
                <p class="text mt-3">هنا يمكنك رؤية الصالونات من خلال محلاتنا .</p>
                        ...
                        <a href="items.html">
                            <div class="card">
                                <div class="row g-0 justify-content-center align-items-center">
                                    <div class="col-md-4 ">
                                        <img src="assets/img/company_1.jpg" class="img-fluid img-radius" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">صالون زمردة</h5>
                                            <p class="card-text">من افخم انواع الصالونات</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm mt-3">
                        <a href="items.html">
                            <div class="card">
                                <div class="row g-0 justify-content-center align-items-center">
                                    <div class="col-md-4 ">
                                        <img src="assets/img/company_2.jpg" class="img-fluid img-radius" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">صالون زهرة المعادي</h5>
                                            <p class="card-text">من افخم انواع الصالونات</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-sm mt-3">
                        <a href="items.html">
                            <div class="card">
                                <div class="row g-0 justify-content-center align-items-center">
                                    <div class="col-md-4 ">
                                        <img src="assets/img/company_3.jpg" class="img-fluid img-radius" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">صالون جميلة</h5>
                                            <p class="card-text">من افخم انواع الصالونات</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="chat-box">
                    ...
                    <form action="index.html" method="post">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-7 mt-3">
                                <textarea name="message" id="" class="w-100 message" cols="30" rows="5"
                                    placeholder="يمكنك التواصل من خلال هذه المحادثه "></textarea>
                            </div>
                            <div class="col-lg-12">
